...
<style>
  ...
  .message-renderer :global(.table-container) {
    @apply mb-4 overflow-x-auto rounded-lg border border-gray-700;
  }

  .message-renderer :global(.markdown-table) {
    @apply w-full border-collapse bg-gray-800;
  }
  ...
  .message-renderer :global(.markdown-td) {
    @apply px-4 py-3 text-gray-300 border-b border-gray-700 last:border-b-0;
  }
